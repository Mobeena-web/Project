...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modal2__ = __webpack_require__(963);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ion2_calendar__ = __webpack_require__(964);
...
var Modal2PageModule = (function () {
    ...
    Modal2PageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__modal2__["a" /* Modal2Page */]),
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(965)(module)))
...
var config_1 = __webpack_require__(776);
...
var calendar_service_1 = __webpack_require__(777);
var moment = __webpack_require__(775);
var config_1 = __webpack_require__(776);
...
var calendar_model_1 = __webpack_require__(778);
var config_1 = __webpack_require__(776);
...
var core_1 = __webpack_require__(1);
var ionic_angular_1 = __webpack_require__(11);
var calendar_modal_1 = __webpack_require__(779);
var calendar_service_1 = __webpack_require__(777);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_calendar__ = __webpack_require__(383);
...
var Modal2Page = (function () {
    // dd :any;
    function Modal2Page(loadingCtrl, server, alertCtrl, calendar, navCtrl, navParams, globals, viewCtrl, modalCtrl, appCtrl, nativeStorage) {
    ...
    Modal2Page.prototype.daysInMonth = function (month, year) {
        return new Date(year, month, 0).getDate();
    };
    Modal2Page.prototype.n = function (n) {
        return n > 9 ? "" + n : "0" + n;
    };
    Modal2Page.prototype.createCalender = function () {
    ...
    Modal2Page.prototype.goToback = function () {
        this.presentModal();
    };
    Modal2Page.prototype.Asap = function () {
        this.type = this.globals.OrderType;
    ...
    Modal2Page.prototype.presentModal = function () {
    ...
    Modal2Page.prototype.Today = function () {
        this.type = this.globals.OrderType;
    ...
    Modal2Page.prototype.Later = function () {
        this.type = this.globals.OrderType;
        localStorage.setItem("segmentvalue", this.settings);
    ...
    Modal2Page.prototype.specific_schedule_change = function (e) {
    ...
    Modal2Page.prototype.checkTimingLater = function () {
        var _this = this;
        this.type = this.globals.OrderType;
                ...
                response.subscribe(function (data) {
                    ...
                    if (data.success == true) {
                        ...
                        if (_this.globals.specific_delivery_day == 'true') {
                            localStorage.setItem("scheduled_time", _this.myDate.format('DD-MM-YYYY'));
                        }
                        else {
                            localStorage.setItem("scheduled_time", _this.myDate);
                        }
                        console.log("setting scheduled time 1", _this.myDate);
                        var current_day = _this.globals.delivery_timing[_this.day];
                        ...
                        console.log(_this.day, _this.time, current_day);
                        if (current_day[0] != 'opened') {
                            if ((Number(current_day[0]) <= Number(_this.time) && Number(current_day[1]) > Number(_this.time)) || (Number(current_day[0]) <= Number(_this.time) && Number(current_day[1]) < Number(current_day[0]))) {
                                _this.presentModal();
                                return true;
                            }
                                ...
                                _this.globals.presentToast('Sorry, we are not serving at this time!');
                                return false;
                            }
                        }
                        else {
            ...
            if (this.globals.pickup_timing) {
                ...
                response.subscribe(function (data) {
                    ...
                    if (data.success == true) {
                        ...
                        console.log("setting scheduled time 2", _this.myDate);
                        var current_day = _this.globals.pickup_timing[_this.day];
                        var n = current_day[0].indexOf('.');
                        if (n != -1) {
                            var res = current_day[0].split(".");
                            current_day[0] = res[0] + '.' + '3';
    ...
    Modal2Page.prototype.checkTiming = function () {
        var _this = this;
        this.type = this.globals.OrderType;
        if (this.type == "delivery") {
            if (this.globals.delivery_timing) {
                var response = this.server.date_convert(this.myDate);
                ...
                response.subscribe(function (data) {
                    ...
                    if (data.success == true) {
                        ...
                        _this.globals.schedule_converted_time = data.time;
                        localStorage.setItem("scheduled_time", _this.myDate);
                        console.log("setting scheduled time 3", _this.myDate);
                        var current_day = _this.globals.delivery_timing[_this.day];
                        var n = current_day[0].indexOf('.');
                        if (n != -1) {
                            var res = current_day[0].split(".");
            ...
            if (this.globals.pickup_timing) {
                ...
                response.subscribe(function (data) {
                    ...
                    if (data.success == true) {
                        ...
                        _this.globals.schedule_converted_time = data.time;
                        localStorage.setItem("scheduled_time", _this.myDate);
                        console.log("setting scheduled time 4", _this.myDate);
                        var current_day = _this.globals.pickup_timing[_this.day];
                        var n = current_day[0].indexOf('.');
                        if (n != -1) {
                            var res = current_day[0].split(".");
    ...
    Modal2Page = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-modal2',template:/*ion-inline-start:"/Users/macbookproratina/projects/mikronexus-customer-demo-app/src/pages/modal2/modal2.html"*/'<!--\n  Generated template for the Modal2Page page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n\n\n\n<ion-content class="main-view " [ngClass]="{\'content_1\': globals.specific_delivery_day === \'false\'}">\n  <div class="overlay" *ngIf="globals.specific_delivery_day === \'false\'">\n\n  </div>\n  <div [ngClass]="{\'modal_content\': globals.specific_delivery_day === \'false\'}">\n    <ion-row>\n      <ion-col col-2 style="margin-left: 0;padding-left: 0 ">\n        <ion-buttons start style="margin-left:0%; padding-left: 0%">\n          <button ion-button (click)="goToback()" class="button_back">\n            <ion-icon name="close"></ion-icon>\n          </button>\n\n        </ion-buttons>\n      </ion-col>\n      <ion-col col-9>\n        <h2 style="text-align: center"> Schedule My Order</h2>\n      </ion-col>\n    </ion-row>\n    <p style="padding-left: 67px;color:#27ae60;margin: 0px;" *ngIf="globals.specific_delivery_day == \'false\'">Select a\n      delivery time up to 5 days</p>\n    <p style=" text-align: center; margin-top:-10px;color:#27ae60" *ngIf="globals.specific_delivery_day == \'false\'"> in\n      advance</p>\n  \n      <ion-segment [(ngModel)]="settings">\n        <ion-segment-button value="Asap">\n          Now\n        </ion-segment-button>\n        <ion-segment-button value="today">\n          Today\n        </ion-segment-button>\n        <ion-segment-button value="later">\n          Schedule\n        </ion-segment-button>\n      </ion-segment>\n    </div>\n    <div [ngSwitch]="settings">\n      <ion-list *ngSwitchCase="\'Asap\'">\n        <ion-item style="margin-bottom: 29%;">\n          <div class="col-4 center-block" style="text-align: center">\n            <p style=" font-size: 22px ; text-align: center;color: #000 "> {{name}} </p>\n            <p *ngIf="type == \'delivery\'" style="font-size: 20px ">{{type}}</p>\n            <p *ngIf="type == \'pickup\'" style="font-size: 22px ">{{type}}</p>\n            <p *ngIf="type == \'delivery\'" style="font-size: 20px ">{{globals.pickupsetting}}</p>\n            <p *ngIf="type == \'pickup\'" style="font-size: 20px ">{{globals.pickup_Time}}</p>\n\n          </div>\n        </ion-item>\n\n      </ion-list>\n\n      <ion-list *ngSwitchCase="\'today\'">\n        <p text-center>Click on time to Schedule</p>\n        <ion-item class="time_d">\n          <!-- <ion-datetime *ngIf="globals.orderT == false && pickup == true" displayFormat="h:mm a" placeholder=" HH:mm" min="{{value}}"\n        max="{{value}}" [(ngModel)]="myDate">\n      </ion-datetime>\n      <ion-datetime *ngIf="Schedule_deliver == true && pickup == false" displayFormat="MMM DD YYYY h:mm a" placeholder="MMM DD YYYY HH:mm "\n        min="{{value}}" [(ngModel)]="myDate">\n      </ion-datetime>\n      <ion-datetime *ngIf="Schedule_deliver == true && pickup == true" displayFormat="MMM DD YYYY h:mm a" placeholder="MMM DD YYYY HH:mm"\n        min="{{value}}" [(ngModel)]="myDate">\n      </ion-datetime> -->\n          <ion-datetime min="{{value}}" displayFormat="h:mm a" pickerFormat="h:mm a" [(ngModel)]="myDate">\n          </ion-datetime>\n          <p>{{value}}</p>\n        </ion-item>\n\n      </ion-list>\n      <ion-list *ngSwitchCase="\'later\'">\n        <p text-center>Click on time to Schedule</p>\n        <ion-calendar *ngIf="globals.specific_delivery_day != \'false\'" [(ngModel)]="myDate"\n          (onChange)="specific_schedule_change($event)" [type]="type" [options]="optionsMulti" [format]="\'YYYY-MM-DD\'">\n        </ion-calendar>\n        <ion-item class="time_d" *ngIf="globals.specific_delivery_day == \'false\'">\n          <ion-datetime min="{{value}}" displayFormat=" MMM DD h:mm a" pickerFormat=" DD h:mm a" [(ngModel)]="myDate">\n          </ion-datetime>\n        </ion-item>\n\n\n      </ion-list>\n    </div>\n    <ion-footer *ngIf="settings == \'Asap\'" padding>\n      <ion-buttons>\n        <button ion-button round block (click)="Asap()">Now </button>\n      </ion-buttons>\n    </ion-footer>\n    <ion-footer *ngIf="settings == \'today\'" padding>\n      <ion-buttons>\n        <button ion-button round [disabled]="today_disable" block (click)="Today()">Today</button>\n      </ion-buttons>\n    </ion-footer>\n    <ion-footer *ngIf="settings == \'later\'" [ngClass]="{\'padding_1\': globals.specific_delivery_day === \'false\'}">\n      <ion-buttons>\n        <button ion-button round block (click)="Later()">Schedule </button>\n      </ion-buttons>\n    </ion-footer>\n\n\n\n</ion-content>'/*ion-inline-end:"/Users/macbookproratina/projects/mikronexus-customer-demo-app/src/pages/modal2/modal2.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["LoadingController"], __WEBPACK_IMPORTED_MODULE_5__providers_server_server__["a" /* ServerProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["AlertController"], __WEBPACK_IMPORTED_MODULE_4__ionic_native_calendar__["a" /* Calendar */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavParams"], __WEBPACK_IMPORTED_MODULE_2__app_global__["a" /* GlobalVariable */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["ViewController"], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["ModalController"], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["App"], __WEBPACK_IMPORTED_MODULE_3__ionic_native_native_storage__["a" /* NativeStorage */]])
    ], Modal2Page);
    return Modal2Page;
}());
...
var calendar_week_component_1 = __webpack_require__(907);
exports.CalendarWeekComponent = calendar_week_component_1.CalendarWeekComponent;
var month_component_1 = __webpack_require__(908);
exports.MonthComponent = month_component_1.MonthComponent;
var calendar_component_1 = __webpack_require__(909);
...
var calendar_controller_1 = __webpack_require__(910);
